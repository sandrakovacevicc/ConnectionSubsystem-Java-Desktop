...
INSERT INTO katastarska_opstina (id_opstine, naziv) VALUES (7, 'Petrovaradin');
INSERT INTO katastarska_opstina (id_opstine, naziv) VALUES (8, 'Novi Sad');
INSERT INTO katastarska_opstina (id_opstine, naziv) VALUES (9, 'Kragujevac');
...
CREATE OR REPLACE PACKAGE "C##APP_USER".Triggers_Context AS
    is_internal_update NUMBER := 0; 
END Triggers_Context;


CREATE OR REPLACE TRIGGER ZABRANA_UPDATE_UKUPNASNAGA
...
INSERT INTO ulica (postanski_br, id_ulice, naziv, id_opstine) VALUES (34000, 7, 'Kragujevac', 9);

CREATE OR REPLACE TRIGGER "C##APP_USER".ZABRANA_UPDATE_NAZIV
BEFORE UPDATE OF naziv_grada
ON Ulica
BEGIN
    RAISE_APPLICATION_ERROR(-20000, 'Zabranjeno je azuriranje ovog polja');
...
SELECT a.constraint_name, a.column_name, c.table_name AS referenced_table, c.constraint_type
FROM user_cons_columns a
JOIN user_constraints c ON a.constraint_name = c.constraint_name
WHERE a.table_name = 'MOLBA_ZA_URBANIZAM'
AND c.constraint_type = 'R'; -- foreign keys only
